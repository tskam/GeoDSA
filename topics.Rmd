...
## Lesson 3: Thematic Mapping and Analysis
...
All About R:
•	tmap package especially tmap: get started!, tmap: version changes and Chapter 8 Making maps with R of Geocomputation with R.
...
•	Density-based point pattern measures (1st order properties)
o	Quadrat analysis
o	Kernel density estimation
•	Distance-based point pattern measures (1st order properties)
o	Nearest Neighbour Index
...
o	Network point density estimation methods
o	Network-Constrained K-function

To read before class:
•	Ripley’s K-function. 
•	Chapter 11 Point Pattern Analysis of Intro to GIS and Spatial Analysis especially Section 11.3.2 and 11.4.
•	Chapter 7 Spatial Point Pattern Analysis of Applied Spatial Data Analysis with R, especially Section 7.3 & 7.5.
...
o	Join count, Moran’s I, Geary’s c
o	Moran scatter plot
o	Spatial correlogram
o	Nonparametric spatial correlogram
...
o	Local Indicators of Spatial Association (LISA)
•	Cluster and Outlier Analysis
o	Local Moran and Local Geary
o	Moran scatterplot
o	LISA Cluster Map
•	Hot Spot and Cold Spot Areas Analysis
o	Getis and Ord’s G-statistics
•	Case Studies
...
o	Gollini, I et. al. (2015) “GWmodel: An R Package for Exploring Spatial Heterogeneity Using Geographically Weighted Models”, Journal of Statistical Software, Volume 63, Issue 17 and 
o	Binbin Lu, Paul Harris, Martin Charlton & Chris Brunsdon (2014) “The GWmodel R package: further topics for exploring spatial heterogeneity using geographically weighted models”, Geo-spatial Information Science, 17:2, 85-101, DOI: 10.1080/10095020.2014.917453.
...
o	The classic model
o	Hansen potential accessibility model
o	Two-step floating catchment area (2SFCA) method 
o	Kernel Density Two-Step Floating Catchment Area (KD2SFCA) Method
